...
from PyQt5.QtWidgets import QWidget, QLabel, QMainWindow, QScrollArea, QVBoxLayout
...
class Marker(Image):
	def __init__(self, path):
		...
		self.healthBar.setStyleSheet("background-color: red;")
		self.setHealth(1)
...
class GameAPI(QMainWindow):
	def __init__(self, game):
		...
		background.setPixmap(QPixmap('assets/field.png'))
